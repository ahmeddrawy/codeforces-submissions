...
void solve(){
    ...
    sudo[0][0] = sudo[0][1];
    sudo[1][0+3] = sudo[1][1+3];
    sudo[2][0+6] = sudo[2][1+6];

    sudo[0+3][1] = sudo[0+3][2];
    sudo[1+3][1+3] = sudo[1+3][2+3];
    sudo[2+3][1+6] = sudo[2+3][2+6];

    sudo[0+6][2] = sudo[0+6][1];
    sudo[1+6][2+3] = sudo[1+6][1+3];
    sudo[2+6][2+6] = sudo[2+6][1+6];
    for (int j = 0; j <9 ; ++j) {
        cout  << sudo[j]<<endl;
    }
